...
object YandexAds {
    ...
    private fun initYandex(ctx: Context) {
        MobileAds.initialize(ctx
        ) { Log.d(YANDEX_MOBILE_ADS_TAG, "SDK initialized") }
    }

    private fun initBanner(banner: BannerAdView) {
...
//    fun initRewarded(ctx: Context) {
//        rewardedAd = RewardedAd(ctx)
//        rewardedAd.setAdUnitId(YANDEX_REWARDED_ID)
//        rewardedListener(rewardedAd)
//        //rewardedAd.loadAd(adRequest)
//    }

//    private fun rewardedListener(rewardedAd: RewardedAd) {
