...
object YandexAdsRepositoryImpl: YandexAdsRepository {
    ...
    override fun showInterstitial() {
        interstitialAd.loadAd(YandexAds.adRequest)
    }

    override fun showRewarded(ctx: Context, openLink: () -> Unit) {
        rewardedAd = RewardedAd(ctx)
        rewardedAd.setAdUnitId(YandexAds.YANDEX_REWARDED_ID)
        ...
        rewardedAd.loadAd(YandexAds.adRequest)
    }
